...
public class IntegerToWords {
    ...
    private static final String[] LESS_THAN_20 = {"", "One", "Two", "Three", "Four", "Five",
    ...
    public static void main(String[] args) {
        ...
        System.out.println(numberToWords(num3)); // One Million Two Hundred Thirty Four Thousand Five Hundred Sixty Seven
    }
}
